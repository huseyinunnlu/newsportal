...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-12 title">
      <h1><i class="fa fa-bars"></i> All Pages <a href="add-page"><button class="btn btn-sm btn-default">Add New</button></a></h1>
    </div>
          ...
          <tbody>
            ...
            <tr>
              <td>
                ...
                <a href="{{url('adminpanel/edit-page')}}/{{$post->id}}">{{$post->title}}</a>
              </td>
              <td>{{$post->status}}</td>
